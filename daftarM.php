		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="daftar.php">
				<span class="contact100-form-title">
					...
					<font size="14">MENARA MBPJ</font>
				</span>

					<div class="wrap-input100 input100-select bg1">
					<span class="label-input100" id="brand">NOMBOR JENAMA *</span>
					<div>
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Model Desktop">
					...
					<input class="input100" type="text" name="No_siri" id="siri">
				</div>
                ...
                <div class="wrap-input100 validate-input bg1" data-validate="Please Type Serial Number">
					...
					<input class="input100" type="text" name="Nama_kom" id="kom">
				</div>
                
                <div class="wrap-input100 input100-select bg1">
					<span class="label-input100" id="jenis">JENIS *</span>
					<div>
                 ...
                 <div class="wrap-input100 input100-select bg1">
					<span class="label-input100" id="sistem">Sistem *</span>
					<div>
