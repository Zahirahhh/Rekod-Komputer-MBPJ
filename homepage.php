              ...
              if (isset($_POST["search"]))
              {
		  		...
		  		<?php           
		              ...
		              ?>
		                ...
		                <td><a href = "update.php?siri=<?php echo $siri ?>"type="button" class="btn btn-warning"><font size="3"><i class = "fa fa-edit"> Kemas Kini</i></font></a></td>
		                <td><a href = "delete.php?siri=<?php echo $siri ?>"type="button" class="btn btn-danger"><font size="3"><i class = "fa fa-trash"> Lupus</i></font></a></td>
				        </tr>
