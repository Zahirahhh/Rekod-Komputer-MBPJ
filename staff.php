...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-30 p-b-20">
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input m-t-60 m-b-35" data-validate = "Masukkan No. Pekerja">
						<input class="input100" type="text" name="pekerja" required="required">
						<span class="focus-input100" data-placeholder="No. Pekerja"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Masukkan Kata Laluan">
	...
	<?php
		...
		{
			$count = 0 ; 
			$res = mysqli_query($connect, "SELECT * FROM staff WHERE No_pekerja = '$_POST[pekerja]' AND password = '$_POST[password]';") ; 
